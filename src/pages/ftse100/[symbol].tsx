...
export default function FTSEStockDetail() {
  ...
  // Eén batch-endpoint voor alle indicatoren (middleware-vriendelijk)
  ...
  // Totaalscore 0..100 (zelfde weging als indexpagina’s)
      ...
      <div className="max-w-4xl mx-auto px-4 py-8 space-y-6">
          ...
          <div className="flex items-center justify-between gap-3">
            ...
            <div className="shrink-0">
              {Number.isFinite(totalScore) ? (
                <ScoreBadge score={totalScore as number} />
              ) : (
        ...
        <div className="flex gap-3">
          ...
          >
            ...
            <span>Back to FTSE 100 list</span>
          </Link>
          <Link
            href="/"
            className="inline-flex items-center gap-1 rounded-md border border-gray-300 bg-gray-100 px-3 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200"
