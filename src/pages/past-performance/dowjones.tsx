...
export default function DowjonesPastPerformancePage({ rows, fetchError }: PageProps) {
  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-8">
      <div className="mb-4 flex items-start justify-between gap-3">
        <div>
          <h1 className="text-2xl font-extrabold">Dow Jones Past Performance</h1>
        </div>
...
export const getServerSideProps: GetServerSideProps<PageProps> = async (ctx) => {
  try {
    ...
    const r = await fetch(`${baseUrl}/api/past-performance/dowjones`, {
