...
export default function Sp500Page() {
  ...
  // 1) Quotes in batches of 50 (20s poll) — identiek gedrag als AEX
  ...
  // 2) Snapshot-list (batches van 50, 30s SWR) — exact zoals AEX maar gebatcht i.v.m. URL-lengte
  ...
  // Summary + heatmap (zelfde als AEX)
