...
export default function HangSeng() {
  ...
  return (
    <>
      <Head><title>Hang Seng Index — SignalHub</title></Head>
                  ...
                  {AEX.map((row, i) => {
                    ...
                    return (
                      <tr key={row.symbol} className="hover:bg-gray-50 dark:hover:bg-slate-800/60">
                        ...
                        <td className="px-4 py-3 text-gray-900 dark:text-slate-100">{price}</td>
              ...
              <div className="table-card p-4">
                ...
                <div className="grid grid-cols-3 gap-2 mb-3">
                  <div className="rounded-xl border border-green-500/30 bg-green-500/10 p-3 text-center">
                    ...
                    <div className="text-xs text-gray-600 dark:text-slate-300">{summary.counts.buy}/{summary.counts.total}</div>
                  </div>
                  <div className="rounded-xl border border-amber-500/30 bg-amber-500/10 p-3 text-center">
                    ...
                    <div className="text-xs text-gray-600 dark:text-slate-300">{summary.counts.hold}/{summary.counts.total}</div>
                  </div>
                  <div className="rounded-xl border border-red-500/30 bg-red-500/10 p-3 text-center">
                    ...
                    <div className="text-xs text-gray-600 dark:text-slate-300">{summary.counts.sell}/{summary.counts.total}</div>
                  </div>
                </div>
