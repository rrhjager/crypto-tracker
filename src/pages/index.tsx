...
function PageInner() {
  ...
  return (
    <main className="max-w-5xl mx-auto p-6">
      <h1 className="text-4xl font-extrabold tracking-tight text_white">{coin.name}</h1>
...
/* ---------- ISR for dynamic routes ---------- */
export async function getStaticPaths() {
  // We laten Next.js routes "on-demand" genereren.
  return { paths: [], fallback: 'blocking' }
}

export async function getStaticProps() {
  // Geen server data nodig; de client haalt live data op.
  return { props: {}, revalidate: 300 } // elke 5 min regenereren
}